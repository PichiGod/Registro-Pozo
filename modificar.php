    ...
    <div class='container'>
        <form >
            ...
            <div class="mb-3">
                ...
                <input type="number" name="PSIEdit" class="form-control" id="idPSIEdit" value="<?php echo $row[2] ?>">
            </div>
            <div class="mb-3">
                <label for="idFechaEdit" class="form-label">Fecha y hora de registro</label>
                <input type="datetime-local" name="FechaEdit" class="form-control" id="idFechaEdit" value="<?php echo $row[3] ?>">
            </div>
            <div class="mb-3">
                <button type="button" class="btn btn-primary" onclick="return modificar()">Guardar</button>
                <button type="reset" class="btn btn-secondary">Volver a lo predeterminado</button>
